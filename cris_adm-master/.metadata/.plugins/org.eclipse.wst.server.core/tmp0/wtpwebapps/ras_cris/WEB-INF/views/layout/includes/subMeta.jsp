...
<script src="${ctxt}/resources/js/commonPop.js"></script>
<script src="${ctxt}/resources/js/paging/jquery.paging.min.js"></script>
...
<!-- 프린트 구분  -->
<c:choose>
	<c:when test = "${PRINTURL eq 'mlib'}">
		<script type="text/javascript" src="${ctxt}/resources/js/jquery.print-preview-mlib.js"></script>
	</c:when> 
	<c:otherwise>
...
<link rel="stylesheet" href="${ctxt}/resources/css/ncmik/KoreaOpenMed.css" type="text/css" />
