...
function fn_rsvReq(acsNoP) {
	...
	if (isLogin == "") {
		if (confirm("예약 기능을 선택하실 경우 로그인 하셔야합니다.\n로그인 화면으로 이동하시겠습니까?")) {
			location.href = "${ctxt}/login/user/login.do?returnURL=/mlib/mlibView06.do?bibctrlno="+bibctrlno;
			return;
		} else {
			return;
		}
...
<form name="reqForm" method="post">
	...
	<div class="sub_center_text">
		...
		<span class="center_text_01">비도서 상세</span>
	</div> 
	...
	<div  class= "content_wrap">
		<div class="content_box">
			...
			<%-- <h2 class="depth-title">${mlibVo.title}</h2>
			<div class="under_bar"></div> --%>
				<div id="bibContent">
					<div id="JOU_bigbox">
						...
						<div id="bibElement"> 
						    ...
						    <!-- MeSH 주제어표제 -->
						     ...
						     <c:if test="${not empty mlibVo.authorno}">
								 <dl>
									<dt>도서기호</dt>
									<dd>
										${mlibVo.authorno}
					...
					<div class="tab-group mlibView" style="margin:40px auto 10px auto;">
							    ...
							    <div class="tab_container" style="width:100%;">
							        <!-- <div id="tab1" class="tab_content"> -->
							        	<table id="tab1" class="basic_table tab_content" cellspacing="0" cellpadding="0" style="border-top:0; table-layout: fixed; margin: 0 0 0 0" summary="번호, 등록번호, 청구기호, 배가위치, 도서상태, 반납예정일, 예약 정보를 가지고 있는 소장정보 테이블 입니다.">
