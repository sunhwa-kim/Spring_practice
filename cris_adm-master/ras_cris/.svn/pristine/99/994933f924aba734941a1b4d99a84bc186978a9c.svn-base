		...
		add_sheet : function(opts) {
			...
			if(opts.url) {
				if(document.createStyleSheet) {
					try { tmp = document.createStyleSheet(opts.url); } catch (e) { var test = "";}
				}
				else {
		...
		_fn : { 
			...
			destroy	: function () { 
				...
				$.each(s.plugins, function (i, val) {
					try { plugins[val].__destroy.apply(_this); } catch(err) {var test = ""; }
				});
				this.__callback();
...
(function ($) {
	...
	$.jstree.plugin("hotkeys", {
		__init : function () {
			if(typeof $.hotkeys === "undefined") { console.log("jsTree hotkeys: jQuery hotkeys plugin not included."); }
			if(!this.data.ui) { console.log( "jsTree hotkeys: jsTree UI plugin not included."); }
	...
	$.jstree.plugin("json_data", {
		...
		_fn : {
			...
			load_node_json : function (obj, s_call, e_call) {
				...
				switch(!0) {
					case (!s.data && !s.ajax): console.log( "Neither data nor ajax settings supplied."); break;
...
(function ($) {
	$.jstree.plugin("cookies", {
		__init : function () {
			if(typeof $.cookie === "undefined") { console.log( "jsTree cookie: jQuery cookie plugin not included."); }
...
(function ($) {
	$.jstree.plugin("checkbox", {
		...
		defaults : {
			...
			real_checkboxes_names : function (n) { return [ ("check_" + (n[0].id || Math.ceil(inner_random() * 10000))) , 1]; }
		},
		__destroy : function () {
			this.get_container()
...
(function ($) {
	$.jstree.plugin("wholerow", {
		__init : function () {
			if(!this.data.ui) { console.log("jsTree wholerow: jsTree UI plugin not included."); }
...
(function ($) {
	...
	$.jstree.plugin("model", {
		__init : function () {
			if(!this.data.json_data) { console.log("jsTree model: jsTree json_data plugin not included."); }
