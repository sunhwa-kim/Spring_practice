...
.email_row, .agency_row{
	width:40%;
	display:inline-block;
	float:left;
}
.email_row > p, .agency_row > p{
	float:left;
	padding-right:10px;
	margin:0;
...
tr.e_mail > .email_right,
tr.agency > .agency_right{
	width:20%;
	position:absolute;
	right:0;
	top:0;
...
<form name="reqForm" method="post">
	...
	<div class= "content_wrap">
		<div class="content_box">
			...
			<div class="notice_box">- 국립의과학 지식센터는 회원에 한해 홈페이지내 서비스 이용 및 전자자원서비스를 이용하실 수 있습니다.</div>
				...
				<div id="divRefreshArea">
					...
					<table class="view_table">
						...
						<tbody class="report">
							<tr>
								<th>
									<label for="user_id"><strong>아이디</strong></label> <font style="color:red">*</font>
								</th>
								<td>
								...
								<th>
									<label for="emplyrnm"><strong>이름</strong></label><font style="color:red">*</font>
								</th>
								<td class="padding_l">
							...
							<tr>
								<th>
									<label for="password"><strong>비밀번호</strong></label> <font style="color:red">*</font>
								</th>
								<td>
									<div>
								...
								<th>
									<label for="password2"><strong>비밀번호 확인</strong></label> <font style="color:red">*</font>
								</th>
								<td class="padding_l">
							...
							<tr>
								<th>
									<label for="brthdy"><strong>생년월일</strong></label> <font style="color:red">*</font>
								</th>
...
<!-- 								</th> -->
<!-- 								<td class="padding_l"> -->
<!-- 									<input name="sex" id="sex1" type="radio" value="M"  onkeypress="if(event.keyCode == 13){ fncMemberIn(); return; }"/><label for="sex1">남자</label> -->
<!-- 					   				<input name="sex" id="sex2" type="radio" value="W"  onkeypress="if(event.keyCode == 13){ fncMemberIn(); return; }"/><label for="sex2">여자</label> -->
<!-- 								</td> -->
							</tr>

							<tr>
								<th>
									<label for="mbtlnum"><strong>휴대전화</strong></label> <font style="color:red">*</font>
								</th>
								<td>
							...
							<tr>
								<th>
									<label for="mouOrg"><strong>기관선택</strong></label> <font style="color:red">*</font>
								</th>
								<td colspan="3" class="padding_l">
									...
									<table>
										...
										<colgroup>
											...
											<tbody>
											<tr class="agency clear">
												<td class="agency_row clear">
													<p><label for="mouOrg">소속기관  :</label></p>
													<p><input name="mouOrg" type="text" id="mouOrg" value="기타기관" readonly  onkeypress="if(event.keyCode == 13){ fncMemberIn(); return; }" /></p>
												</td>
												<td class="agency_row clear">
													<p><label for="mouSub">과 : </label></p>
													<p><input name="mouSub" type="text" id="mouSub" value="기타기관" readonly  onkeypress="if(event.keyCode == 13){ fncMemberIn(); return; }"/></p>
												</td>
												<td class="agency_right"><input type="button" name="instchk" alt="기관선택 새창" value=" 기관선택 " class="red"  onclick="popup('${ctxt}/member/regi/InsttsnList.do',1000,700,1);" style="width:100%;padding:0;"title="기관선택-새창"/></td>
											</tr>
										</tbody>
									</table>
								</td>
							...
							<tr>
								<th>
									<label for=""><strong>이메일</strong></label><font style="color:red">*</font>
								</th>
								<td colspan="3" class="padding_l">
									<table>
										<caption>
										...
										<colgroup>
											...
											<tr class="e_mail clear" style="width:100%;">
												<td class="email_row">
													<p><label for="email1" class="blind">이메일ID</label></p>
													<p><input id="email1" name="email1" title="이메일"  type="text" rows="15" value="" maxlength="30"  onkeypress="if(event.keyCode == 13){ fncMemberIn(); return; }"/></p>
												</td>
												<td class="email_row">
													<p><label for="email2" class="blind">@ 이메일주소</label></p>
													<p><input id="email2" name="email2" title="이메일"  type="text" rows="15" value="" maxlength="30"  width="*" onkeypress="if(event.keyCode == 13){ fncMemberIn(); return; }"/></p>
												</td>
												<td class="email_right">
													<select class="" id="email3" name="selEmailOpt" title="주 사용 전자우편(E-mail)" style="width:100%;height:25px;margin-right:0;vertical-align:middle;">
							...
							<tr>
								<th>
								<label for=""><strong>주소</strong></label><font style="color:red">*</font>
								</th>
								<td colspan="3" class="padding_l" >
									<ul class="address_box">
										<li style="position:relative"><input type="text" name="zipcode" id="zipcode"  onkeypress="if(event.keyCode == 13){ fncMemberIn(); return; }" placeholder="우편번호">
										<input type="button" onclick="execDaumPostcode()" value="우편번호 찾기" style="position:absolute;right:0;top:9px;width:190px;"></li>
