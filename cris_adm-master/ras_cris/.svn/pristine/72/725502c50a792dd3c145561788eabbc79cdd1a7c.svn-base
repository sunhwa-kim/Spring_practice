$(function() {
    ...
    accordion.openSubMenuAt(1, true);
    accordion.openSubMenuAt(2, true);
    
    accordion.openSubMenuAt(3, true);
    accordion.openSubMenuAt(4, true);
    accordion.openSubMenuAt(5, true);
    accordion.openSubMenuAt(6, true);
    accordion.openSubMenuAt(7, true);
    accordion.openSubMenuAt(8, true);
    accordion.openSubMenuAt(9, true);
