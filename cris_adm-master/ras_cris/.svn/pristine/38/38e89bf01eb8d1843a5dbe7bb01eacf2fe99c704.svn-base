...
<form:form name="reqForm" method="post">
	...
	<div class="sub_center_text">
		<div class="sub_center_nav"> 
			...
			<span>교육/서비스</span>
			<span> > </span>
			<span class="active">교육 일정</span>        			      
		</div>
		<span class="center_text_01">교육 일정</span>
	</div> 
	...
	<!-- 목록 화면 주소  -->
	<input type="hidden" id="returnListPage" name="returnListPage" value="${ctxt}/centerintro/edu/listEdu.do" alt= "returnPage" />
