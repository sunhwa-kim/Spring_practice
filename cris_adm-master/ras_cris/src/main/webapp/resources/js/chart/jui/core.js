(function (window, nodeGlobal) {
	...
	var utility = global["util.base"] = {
		...
		createId: function (key) {
			return [key || "id", (+new Date), Math.round(inner_random() * 100) % 100].join("-");
		},
		/**
		 * @method btoa
		 *
	...
	var self = {
		...
		parseAttr : function(type, str) {
			...
			if (type == 'linear') {
				...
				switch(str) {      
					case "left": a=1; return { x1 : 0, y1 : 0, x2 : 1, y2 : 0, direction : str || "left" };break;
					case "right":a=1; return { x1 : 1, y1 : 0, x2 : 0, y2 : 0, direction : str };break;
					case "top":a=1; return { x1 : 0, y1 : 0, x2 : 0, y2 : 1, direction : str };break;
					case "bottom":a=1; return { x1 : 0, y1 : 1, x2 : 0, y2 : 0, direction : str };break;
					case "top left":a=1; return { x1 : 0, y1 : 0, x2 : 1, y2 : 1, direction : str };break;
					case "top right":a=1; return { x1 : 1, y1 : 0, x2 : 0, y2 : 1, direction : str };break;
					case "bottom left":a=1; return { x1 : 0, y1 : 1, x2 : 1, y2 : 0, direction : str };break;
					case "bottom right":a=1; return { x1 : 1, y1 : 1, x2 : 0, y2 : 0, direction : str };break;
					default :
						a=1; 
						var arr = str.split(",");
						for(var i = 0, len = arr.length; i < len; i++) {
