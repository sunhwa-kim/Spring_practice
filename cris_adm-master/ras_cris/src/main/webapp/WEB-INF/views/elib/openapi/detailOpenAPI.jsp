...
function fn_openApiPop(){
	...
	var url = "${ctxt}/srv/openapi/kFetch.do";
	var w = "1200";
	var h = "800";
	var l, t;
	l = (screen.width-w)/2;
...
@media (max-width: 450px){
	...
	<div class="sub_center_text">
		<div class="sub_center_nav"> 
			...
			<span>전자자원</span>
			<span> > </span>
			<span class="active">상세정보</span>        
		</div>
		<span href="#" class="center_text_01">상세정보</span>
	</div> 
		...
		<div class="content_wrap">
				...
				<div class="content_list">
					<div class="tabContainer"> 
						<ul class="tabs">
					        ...
					        <li class="active" rel="tab3" style="box-sizing:border-box;" onclick="">상세정보</li>				    
						</ul>
					...
					<ul class="list_full_2">
						<li class="list_number2">kFetch Input</li>
					</ul>
			...
			<thead>
			  <tr>
			    ...
			    <th>검색리스트</th>
			    <th colspan="2"><span class="none link">호출url</span></th>
			    <th colspan="2" style="position:relative;"><span class="none link">http://library.nih.go.kr${ctxt}/srv/openapi/kFetch.do</span><span class="none link2">http://library.nih.go.kr${ctxt}/ srv/openapi/kFetch.do</span></th>
			  </tr>
			  <tr>
			    <th>No</th>
			    <th>요청송신 필드명</th>
			  ...
			  <tr>
				...
				<ul class="list_full_2">
					<li class="list_number2">kFetch Output</li>
				</ul>
			...
			<div class="btn-group">
				<span class="application">예시 : http://library.nih.go.kr${ctxt}/srv/openapi/kFetch.do?artctrlNo=5357534</span>
	...
	<form name ="apiForm">
		<input type="hidden" id="artctrlNo" name="artctrlNo" value="5357534" alt="논문번호">
	</form>
