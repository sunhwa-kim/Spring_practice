...
function selMyLib(artctrlno) {
 	...
 	if ("${userVo.emplyrnm}" == "") {
		if (confirm("내서재 담기 기능을 선택하실 경우 로그인 하셔야합니다.\n로그인 화면으로 이동하시겠습니까?")) {
			location.href = "${ctxt}/login/user/login.do?returnURL=/elib/kom/listArticleKM.do?keyword=${archiveReportVo.searchKeyword}";
			return;
		} else {
			return;
		}
...
<%-- <form id="journalForm" name="journalForm" method="post" action="${ctxt}/elib/kom/listArticleKM.do"  >
...
<form id="searchMove" name="searchMove" action="${ctxt}/elib/kom/listArticleKM.do" method="post">  
	<input type="hidden" name="searchGubun" value="board"/>
	<input type="hidden" id="cate" name="subCategory" value="in"/>
	...
	<input type="hidden" id="db_gbn" name="db_gbn" value="KMBASE" />
	<div id="view_list">
	...
	<div class="sub_center_text">
		...
		<form id="inkoreaForm" name="inkoreaForm" action="${ctxt}/elib/kom/listArticleKM.do" method="post">
			...
			<div class="content_list">
				<div class="sub_book_wrap">
					<div class="selectbox_wrap">
						...
						<span class ='txt-red' >Search results: ${vo.pageNum} &nbsp;to&nbsp; ${pageTotalCnt} &nbsp;of&nbsp; ${data.inkorea_totalSize}</span>
				...
				<div id="sidebar-pumed-right" style="margin-top:75px;">
