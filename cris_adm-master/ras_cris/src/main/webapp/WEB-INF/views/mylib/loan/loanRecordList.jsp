...
function fn_search(page,selectMenu){
	...
	****************************************************************/
    ...
    $.ajax({
        url: '${ctxt}/mylib/loan/loanRecordRead.do',
        data: params,
        type: 'POST',
        dataType: 'text',
        cache: false,
			...
			if(xmlList.length > 0){
				...
				xmlList.each(function(cnt){
					...
					****************************************************************/
					...
					html += ' <td style="text-align: center" >'+obj.find('returndatetime').text() + '</td>';
...
<form name="reqForm" method="post">
	<div class="sub_center_text">
		<div class="sub_center_nav"> 
			...
			<span> > </span>
			<span class="active">대출 이력</span>        
		</div>
		<span class="center_text_01">대출 이력</span>
	</div> 
